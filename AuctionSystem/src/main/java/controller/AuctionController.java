...
public class AuctionController {
    ...
    private void onPlaceBidClick(ActionEvent event) {
        try {
            ...
            // SENIOR WAY: Gửi lệnh qua Socket, không gọi DAO!
            ClientRequest bidRequest = new ClientRequest("BID", currentAuctionId, loggedInUserId, bidAmount);
            AuctionSocketClient.getInstance().sendRequest(bidRequest);
