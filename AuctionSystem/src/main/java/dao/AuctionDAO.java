...
public class AuctionDAO {
    ...
    // lấy người đặt giá cao nhất nếu cùng giá thì lấy người sớm hơn
    ...
    /**
     * Chức năng 3.1.2: Xóa sản phẩm an toàn dừ lỗi hay không thì sẽ đống connecttion với  PreparedStatement 
     * để tránh lỗi dữ liệu . Và ngoại lệ không thể xoá sản phẩm nếu sản phẩm đang được đấu gía (Foreign Key Constraint")
     */
