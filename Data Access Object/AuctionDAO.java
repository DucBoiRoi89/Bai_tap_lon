...
public class AuctionDAO {
    ...
    /**
     * Chức năng 3.1.3: Đặt giá qua Stored Procedure (Xử lý đồng thời tại DB)
     *
     */
    ...
    /**
     * Lấy ID người giữ giá cao nhất để gửi thông báo OUTBID nâng cao
     */
    ...
    /**
     * Chức năng 3.1.2: Cập nhật Item đa tầng sử dụng Transaction
     *
     */
    public boolean updateItem(Item item) {
        ...
        try {
            ...
            try (PreparedStatement psBase = conn.prepareStatement(sqlUpdateBase)) {
                ...
                psBase.setString(2, "Mô tả sản phẩm"); // Nên bổ sung getDescription() vào Item.java
                psBase.setInt(3, Integer.parseInt(item.getId()));
                psBase.executeUpdate();
            }

            // 2. Cập nhật bảng con tương ứng (Đa hình)
